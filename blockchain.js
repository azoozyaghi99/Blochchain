...
class Header {
        constructor(version,Difficulty,timestamp,merkle_root = 0,previousHash = "" )
        {
...
class block{
    ...
    calculatehash(){
        return SHA256(this.index+this.datacount+JSON.stringify(this.data)+JSON.stringify(this.Header)).tostring();
    }
